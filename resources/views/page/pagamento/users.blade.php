...
@section('tbody')
    @foreach ($users as $user)
        <tr>
            ...
            <td>
                <button type="button" class="bg-none text-secondary rounded text-center btn-create" data-bs-toggle="modal" data-bs-target="#modalCreate"  url="{{ route('pagamento.users.store',[$pagamento->id, $user->user_morador_id]) }}">
